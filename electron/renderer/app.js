(() => {
  ...
  function normalizeComposerProject(project) {
    ...
    return { id: String(project.id), name: project.title, title: project.title, url: typeof project.url === "string" ? project.url : "" };
  }
  ...
  function post(action, payload = {}) {
    ...
    window.issuesDesktop?.post(message);
  }
  ...
  function renderSettings() {
    ...
    nodes.savedTokenLabel.textContent = state.hasSavedToken ? "Token stored securely" : "No saved token";
  ...
  window.issuesDesktop?.onState(render);
  post("ready");
})();
